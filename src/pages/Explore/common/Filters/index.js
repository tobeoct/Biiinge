...
export const Filters=({style})=>{
    ...
    return  <ScrollAnimation animateIn="fadeIn" animateOut="zoomOut" isVisible={true} offset={80}><div className="explore-filter__container scrolling-wrapper" style={myStyle}>
